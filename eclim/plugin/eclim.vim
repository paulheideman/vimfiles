...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/Users/paul.heideman/Documents/tools/eclipse-indigo/plugins/org.eclim_1.7.9'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/Users/paul.heideman/Documents/tools/eclipse-indigo'
  if has('win32unix')
